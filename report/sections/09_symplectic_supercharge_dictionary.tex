...
The script \path{scripts/lattice_codes/css_supercharge_symplectic_dictionary.jl}
validates the dictionary without building Hilbert matrices. It checks the binary
Steane CSS code and a qutrit CSS toy code. The CSV
\path{runs/2026-05-24-css-supercharge-symplectic-dictionary/data/css_supercharge_symplectic_dictionary.csv}
records CSS isotropy, stabilizer rank, code dimension, logical symplectic
dimension, ghost counts, and the \(Q^2\) and anticommutator certificates.
