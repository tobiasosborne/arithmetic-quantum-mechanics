...
\]
By the AQM-19 finite-mode CCR convention, the irreducible regular projective
representation has a Hilbert carrier.  In the standard analytic realization on
\(L^2(\mathbb R)\), position is multiplication by \(x\) and momentum is
