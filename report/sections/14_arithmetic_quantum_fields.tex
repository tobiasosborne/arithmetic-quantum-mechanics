...
The producer is \path{scripts/bridges/arithmetic_quantum_fields.jl}.  It writes
...
The summary CSV records point counts, scalar Gram ranks, symplectic ranks,
radicals, reduced Weyl label counts, Hilbert dimensions, and observable-algebra
dimensions.  The basis CSV records every scalar basis vector and every scalar
Gram row used in the examples above.
