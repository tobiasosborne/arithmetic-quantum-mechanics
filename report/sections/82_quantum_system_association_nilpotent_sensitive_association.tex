...
\texttt{available locally}: one \(\mathbb F_3\) residue site; database helper
...
\(\mathbb F_3[t]/(t^3)\) or
\(\mathbb F_3[t]/((t-1)^3)\) &
\texttt{available locally}: one \(\mathbb F_3\) residue site by AQM-34,
AQM-35, and AQM-81. &
...
\texttt{available only} for the AQM-77 cotangent comparison; no standardized
...
\texttt{blocked/database} except for local AQM-77 cotangent anchors. &
