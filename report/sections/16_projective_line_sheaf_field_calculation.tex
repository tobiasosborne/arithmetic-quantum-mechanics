...
\path{scripts/bridges/projective_line_sheaf_fields.jl}, with run bundle
\path{runs/2026-05-24-projective-line-sheaf-fields/}.
The output files are \path{data/projective_line_sheaf_field_summary.csv} and
\path{data/projective_line_sheaf_field_basis_rows.csv}.
