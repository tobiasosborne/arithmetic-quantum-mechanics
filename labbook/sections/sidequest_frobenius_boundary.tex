...
The statements below have passed the capped review.
...
\end{scope}
\provenance{D1331}{definitions.md}{orbit checker B1}{frobenius-boundary-adjudication.md}
...
{orbit checker B1--B2}{frobenius-boundary-adjudication.md}
...
\end{scope}
\provenance{D1332}{definitions.md}{orbit checker B2--B3}{frobenius-boundary-adjudication.md}
...
{orbit checker B2--B3}{frobenius-boundary-adjudication.md}
...
\end{scope}
\provenance{D1333}{definitions.md}{orbit checker B4--B5}{frobenius-boundary-adjudication.md}
...
{orbit checker B4--B5}{frobenius-boundary-adjudication.md}
...
For $E=\mathbb F_{p^r}$ with its named primitive root $\zeta_p$, let
...
{orbit checker B6}{frobenius-boundary-adjudication.md}
