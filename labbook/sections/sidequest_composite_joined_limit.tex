...
together in trace norm. This theorem passed its own capped review, with the exact input reference
...
\]
Prepare the classical degree tag with these probabilities. In the selected
degree prepare the exact period reference $\rho_{E_d}(\log t)$, then apply
the three copied-reference preparation amplitudes. On success,
