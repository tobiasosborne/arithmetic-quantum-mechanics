...
field-with-one-element sidequest, has \textbf{121} rows: \textbf{96}
\statusProved{}, \textbf{23} \statusSketch{}, one \statusConjecture{} and
...
Section~\ref{sec:frobenius-boundary} adds four sketches for a positive
...
the new sketches have exact checks and await independent capped review.
