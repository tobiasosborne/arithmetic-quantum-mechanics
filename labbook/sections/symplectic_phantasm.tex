...
The assembled propositions below remain sketches pending their own
promotion review. Their finite probes check the interfaces with the
admitted constructions. They do not constitute a new proof of those
foundations or a mathematical type checker for the whole programme.
...
completion. These questions accompany the existing lemma order; the
Weyl, affine-symmetry and tensor comparisons remain the next bounded work.
...
\end{definition}
\begin{scope}
The half-form convention excludes characteristic two. The finite-abelian realization is already admitted; SP-WEYL records its coordinate, phase and central-quotient transport.
\end{scope}
\provenance{D1703}{Stipulation; SP-GH07, SP-PRASAD09, SP-GROSS06}{See the scoped bridge checks}{Reuses: D3,D4,D5,D8,D1001,D1002,D1003,D1301,D1701; no promotion}
