...
sums below have passed their capped reviews. The remaining six propositions
...
\provenance{SP-WEYL,SP-EGOROV,SP-TENSOR,SP-LREL,SP-COMPACT,SP-STAB-REL,SP-SCALAR,SP-CP,SP-SUM}{Structured local, relation, process and sum proofs}{Exact finite bridge, affine, relation, stabilizer and process probes}{Stage-1, relation, process and sum adjudications}
...
tensor unit. The next work is the arithmetic trace, Frobenius and subsystem
interfaces. Operator vectorization and the
...
\provenance{SP-COMPACT,SP-STAB-REL,SP-SCALAR,SP-CP,SP-SUM}{Admitted compact, projective, process and sum comparisons}{Finite controls at their declared scope}{Relation, process and sum adjudications}
