...
comparison, scalar normalization and finite instrument laws below have
passed their capped reviews. The remaining seven propositions retain sketch
...
\provenance{SP-WEYL,SP-EGOROV,SP-TENSOR,SP-LREL,SP-COMPACT,SP-STAB-REL,SP-SCALAR,SP-CP}{Structured local, relation and process proofs}{Exact finite bridge, affine, relation, stabilizer and process probes}{Stage-1, relation and process adjudications}
...
ambient reverse map and need not be a reverse branch. The next bounded work
is the coherent-sum and classical-tag comparison, followed by the arithmetic
trace, Frobenius and subsystem interfaces. Operator vectorization and the
...
\provenance{SP-COMPACT,SP-STAB-REL,SP-SCALAR,SP-CP,SP-SUM}{Admitted compact, projective and process comparisons; sum task remains}{Finite controls at their declared scope}{Relation and process adjudications; sum remains a sketch}
