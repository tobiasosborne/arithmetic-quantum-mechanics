...
comparison below have passed their capped reviews. The remaining nine
propositions retain sketch status. Their finite probes check the interfaces with admitted
constructions; the arbitrary-rank conclusions rest on the written proofs.
\provenance{SP-WEYL,SP-EGOROV,SP-TENSOR,SP-LREL,SP-COMPACT,SP-STAB-REL}{Structured local and relation proof shards}{Exact finite bridge, affine, relation and stabilizer probes}{Stage-1 and relation-cluster adjudications}
...
comparison likewise identifies all nonzero scalar multiples. The next
bounded work is to specify successful branches and instruments using
actual amplitudes and ordinary traces, and to compare operator
vectorization with the Choi construction for completely positive maps.
That comparison will inform the additional relation data and the
compatibility required of an additive completion.
...
\provenance{SP-COMPACT,SP-STAB-REL,SP-SCALAR,SP-CP,SP-SUM}{Admitted compact and projective comparison; remaining process contracts}{Finite controls at their declared scope}{Compact/comparison admitted; scalar, CP and sum tasks remain sketches}
