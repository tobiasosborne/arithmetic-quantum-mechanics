...
\]
Write $P_r^L$ for this same permutation average on $L^{\otimes r}$ when
the Hilbert space needs to be displayed. Set
...
\]
Here $\odot$ denotes the algebraic tensor product over $\mathbb C$.
