...
The two claims in this section are drafts awaiting independent review.
...
and $\alpha$-invariant. The normalizer satisfies
\[
...
\[
 ...
 =\zeta(\beta).
\]
Removing the $d=1$ term gives the claimed subtraction. The moment formula
