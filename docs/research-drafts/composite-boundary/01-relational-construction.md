...
2026-09-09. Root prover. Proposed claims CMP-SOURCE, CMP-REL, CMP-NATURAL.
UNREVIEWED. Definitions: DEFINITIONS-PROPOSED.md, D1601--D1606. Existing
...
ASSUME D1604. PROVE the preparation is an actual retained instrument and
separate orbit descent does not supply its whole relative-index register.
