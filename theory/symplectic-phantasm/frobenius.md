...
SP-FROB is `PROVED` through `theory/verdicts/phantasm-arithmetic-adjudication.md`,
admitted after its explicit SP-TRACE dependency.
...
**ASSUME** an odd-characteristic extension `E/K`, write `q=|K|=p^s` and
