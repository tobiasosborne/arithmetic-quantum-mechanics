...
2026-09-09. Root prover. CMP-COMPLETE and CMP-MELLIN are PROVED
within their stated scopes after capped review and mechanical minor repair.
Definitions: ../../../definitions.md, D1611--D1612. Inputs:
...
PROVE it is finite, strictly positive, with the stated tail bound.
  <2>1. For every INTEGER cutoff D>=1, since 1<=phi(d)<=d, the
  terms are positive and at most d^(-beta). Their tail after D is bounded by
...
Admission: ../../verdicts/composite-spectrum-adjudication.md.

Source corroboration only: NIST DLMF 27.4.E6, retrieved in
refs/composite-spectrum/dlmf-27-4/, records the classical totient Dirichlet
series. Section 3 derives the required real-domain identity independently;
no novelty of that scalar identity or analytic continuation is asserted.
